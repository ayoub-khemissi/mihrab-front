...
export default function ClosestJobOffers() {
  ...
  return jobOffers.map((jobOffer, idx) => {
    ...
    return (
      <button
        key={jobOffer.id + "-" + idx}
        className="bg-secondary rounded-xl shadow-md w-full max-w-[420px] flex flex-col p-6 gap-4 items-center sm:items-start border border-gray-200 hover:shadow-lg transition-shadow relative"
      >
